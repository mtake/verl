...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3_8b_grpo_${INFER_BACKEND}_fsdp}  # Originally qwen3_8b_grpo_${INFER_BACKEND}_fsdp_$(date +%Y%m%d_%H%M)
########################### end user-adjustable ###########################
...
DATA=(
    ...
    data.train_files="['$DATA_ROOT/gsm8k/train.parquet', '$DATA_ROOT/math/train.parquet']"
    data.val_files="['$DATA_ROOT/gsm8k/test.parquet', '$DATA_ROOT/math/test.parquet']"
