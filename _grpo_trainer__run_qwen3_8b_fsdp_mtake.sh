...
# @@@ahoaho XXX
#cmd="${ENV}bash examples/grpo_trainer/run_qwen3_8b_fsdp.sh"
cmd="${ENV}bash examples_mtake/grpo_trainer/run_qwen3_8b_fsdp_mtake.sh"
...
#
#PROJECT_NAME=verl_grpo_gsm8k_math
#EXPERIMENT_NAME=qwen3_8b_grpo_${INFER_BACKEND}_fsdp
